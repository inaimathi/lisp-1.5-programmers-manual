...
END   TXS
   ...
   INCA          STACK-LIMIT ON PAGE BOUNDRY.
...
MARKL   BEQ   MARKEX   EMPTY LIST
   CLRA
   PSHA            SET BOTTOM OF WORKSTACK TO NIL.
   PSHA
...
* ASSOCIATED WITH THIS INDICATOR; OTHERWISE RETURN NIL.
*
...
PUTIN   STAA   NUM1   CREATE A NUMERIC ATOM
   ...
   RTS
 PAG
* Note: Was FCS originally
SN.MS   FCC   'SYNTAX ERRO'
	FCB   $D2
